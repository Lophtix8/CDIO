...
def run_md(supercell_path: str, temp: float, num_steps: int, strain_rate: int, strain_interval: int, potential_id:str):
...
if __name__ == "__main__":
    ...
    run_md(poscar_path, temp, iterations, 0.001, 5, potential_id)